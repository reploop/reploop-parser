...
/**
 * This class provides an empty implementation of {@link MySQLParserVisitor}, which can be
...
public class MySQLParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements MySQLParserVisitor<T> {
	 ...
	 */
	@Override
	public T visitAlterUserMysqlV57(MySQLParser.AlterUserMysqlV57Context ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitCreateUserMysqlV57(MySQLParser.CreateUserMysqlV57Context ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitPasswordAuthOption(MySQLParser.PasswordAuthOptionContext ctx) {
		return visitChildren(ctx);
	}
