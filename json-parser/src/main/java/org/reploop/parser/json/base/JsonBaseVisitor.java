...
public interface JsonBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code numberValue} labeled alternative in
	 * {@link JsonBaseParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code objValue} labeled alternative in
	 * {@link JsonBaseParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code arrValue} labeled alternative in
	 * {@link JsonBaseParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code trueValue} labeled alternative in
	 * {@link JsonBaseParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code falseValue} labeled alternative in
	 * {@link JsonBaseParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code nullValue} labeled alternative in
	 * {@link JsonBaseParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
