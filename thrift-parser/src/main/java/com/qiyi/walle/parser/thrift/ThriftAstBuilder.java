...
import static com.qiyi.walle.parser.thrift.base.ThriftBaseParser.*;
...
public class ThriftAstBuilder extends ThriftBaseBaseVisitor<Node> {
    ...
    public Field visitField(FieldContext ctx) {
        ...
        boolean required = (null != node && Requiredness.REQUIRED == Requiredness.valueOf(node.getText().toUpperCase()));
