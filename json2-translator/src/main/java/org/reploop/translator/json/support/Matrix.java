...
public class Matrix {
	 ...
	 * @return another point, let the given point (f,m) as the left top point, then this
	 * point right bottom point of a rect.
	 */
	...
	/**
	 * Left top point (f1,m1), right bottom point (f2,m2). Test if all cells in this rect
	 * are set.
