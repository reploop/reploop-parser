...
public class FieldTypeComparator implements Comparator<FieldType> {
	...
	/**
	 * It's only number, string and object need to compare. StructType should not be
	 * different from each other, so they are same.
	 *
	 * <p>
	 * String > Number String > Object Number > Object
	 * </p>
