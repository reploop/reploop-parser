...
public class NameSupport {
	...
	public static final QualifiedName IMPORT_JSON_PROPERTY = QualifiedName
		.of("com.fasterxml.jackson.annotation.JsonProperty");

	public static final QualifiedName IMPORT_JSON_FORMAT = QualifiedName
		.of("com.fasterxml.jackson.annotation.JsonFormat");

	public static final QualifiedName IMPORT_JSON_IGNORE = QualifiedName
		.of("com.fasterxml.jackson.annotation.JsonIgnoreProperties");
	...
	public static boolean shouldExplicitImport(QualifiedName qn, QualifiedName exist) {
		...
		if (0 == c) {
			...
			// #5 Now we can tell the two in the same package, so do not need to import
			// explicitly.
			return false;
		}
		return true;
