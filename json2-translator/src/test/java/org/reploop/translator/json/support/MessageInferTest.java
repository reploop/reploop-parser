...
public class MessageInferTest {
	...
	public void maxArea() {
		...
		Field f1 = new Field(FieldModifier.required, 0, "name", new StringType(), Optional.empty(),
				Collections.emptyList());
		Field f2 = new Field(FieldModifier.required, 0, "id", new StringType(), Optional.empty(),
				Collections.emptyList());
		Field f3 = new Field(FieldModifier.required, 0, "version", new StringType(), Optional.empty(),
				Collections.emptyList());
		...
		Field f21 = new Field(FieldModifier.required, 0, "name", new StringType(), Optional.empty(),
				Collections.emptyList());
		Field f22 = new Field(FieldModifier.required, 0, "id", new StringType(), Optional.empty(),
				Collections.emptyList());
