...
public class JsonThriftGenerator extends AstVisitor<Node, JsonBeanContext> {
    private static final Logger LOG = LoggerFactory.getLogger(JsonThriftGenerator.class);
