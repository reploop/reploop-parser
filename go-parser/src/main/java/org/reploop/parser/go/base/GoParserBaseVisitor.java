...
/**
 * This class provides an empty implementation of {@link GoParserVisitor}, which can be
...
public class GoParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements GoParserVisitor<T> {
	 ...
	 */
	@Override
	public T visitEmptyStmt(GoParser.EmptyStmtContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitUnaryExpr(GoParser.UnaryExprContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitAnonymousField(GoParser.AnonymousFieldContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitSlice(GoParser.SliceContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitReceiverType(GoParser.ReceiverTypeContext ctx) {
		return visitChildren(ctx);
	}
