...
service WriteRpcService {
  ...
  /**
   * write统一接口,使用bytes传输数据
   */
  binary writeEntity(1:binary write_entity_request)
      throws (1:InvalidWriteOperation e);

  binary setMetadata(1:binary set_metadata_request)
      throws (1:InvalidWriteOperation e);
  binary setPeopleMetadata(1:binary set_people_metadata_request)
      throws (1:InvalidWriteOperation e);
  binary setImageMetadata(1:binary set_image_metadata_request)
      throws (1:InvalidWriteOperation e);
  ...
  binary setPpsUgcChannelMetadata(1:binary set_pps_ugc_channel_metadata_request)
      throws (1:InvalidWriteOperation e);
  binary setOrganizationSharePartnerMetadata(1:binary set_organization_share_partner_metadata_request)
      throws (1:InvalidWriteOperation e);
  ...
  /**
   * The write interfaces of setting for Episode|UgcEpisode.
   * Set the field of quality from the entity of Episode|UgcEpisode,
   * or throws an exception if this operation is not valid.
   */
  binary setQualityScore(1:binary set_quality_score_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Festival.
   * Set the field of metadata from the entity of Festival,
   * or throws an exception if this operation is not valid.
   */
  binary setFestivalMetadata(1:binary set_festival_metadata_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Collection.
   * Set the field of event from the entity of Collection,
   * or throws an exception if this operation is not valid.
   */
  binary setCollectionEvent(1:binary set_collection_event_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Collection.
   * Add the field of related_character from the entity of Episode|Album|Character,
   * or throws an exception if this operation is not valid.
   */
  binary addRelatedCharacter(1:binary add_related_character_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Collection.
   * Delete the field of related_character from the entity of Episode|Album|Character,
   * or throws an exception if this operation is not valid.
   */
  binary deleteRelatedCharacter(1:binary delete_related_character_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Presenter.
   * Set the field of own_room_id from the entity of Presenter,
   * or throws an exception if this operation is not valid.
   */
  binary setOwnRoomId(1:binary set_own_room_id_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Presenter.
   * Set the field of ongoing_room_id from the entity of Presenter,
   * or throws an exception if this operation is not valid.
   */
  binary setOngoingRoomId(1:binary set_ongoing_room_id_request)
      throws (1:InvalidWriteOperation e);
  ...
  /**
   * The write interfaces of setting for Festival.
   * Set all field of Festival,
   * or throws an exception if this operation is not valid.
   */
  binary setFestival(1:binary set_festival_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for SpecialSubject.
   * Set all field of SpecialSubject,
   * or throws an exception if this operation is not valid.
   */
  binary setSpecialSubject(1:binary set_special_subject_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Character.
   * Set all field of Character,
   * or throws an exception if this operation is not valid.
   */
  binary setCharacter(1:binary set_character_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Taxonomy.
   * Set all field of Taxonomy,
   * or throws an exception if this operation is not valid.
   */
  binary setTaxonomy(1:binary set_taxonomy_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for GraphEntity.
   * Set all field of GraphEntity,
   * or throws an exception if this operation is not valid.
   */
  binary setGraphEntity(1:binary set_graph_entity_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Book.
   * Set all field of Book,
   * or throws an exception if this operation is not valid.
   */
  binary setBook(1:binary set_book_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for BookVolume.
   * Set all field of BookVolume,
   * or throws an exception if this operation is not valid.
   */
  binary setBookVolume(1:binary set_book_volume_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for BookChapter.
   * Set all field of BookChapter,
   * or throws an exception if this operation is not valid.
   */
  binary setBookChapter(1:binary set_book_chapter_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Category.
   * Set all field of Category,
   * or throws an exception if this operation is not valid.
   */
  binary setCategory(1:binary set_category_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for FestivalSeries.
   * Set all field of FestivalSeries,
   * or throws an exception if this operation is not valid.
   */
  binary setFestivalSeries(1:binary set_festival_series_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for FestivalAward.
   * Set all field of FestivalAward,
   * or throws an exception if this operation is not valid.
   */
  binary setFestivalAward(1:binary set_festival_award_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for OperationTip.
   * Set all field of OperationTip,
   * or throws an exception if this operation is not valid.
   */
  binary setOperationTip(1:binary set_operation_tip_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Paopao.
   * Set all field of Paopao,
   * or throws an exception if this operation is not valid.
   */
  binary setPaopao(1:binary set_paopao_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Circle.
   * Set all field of Circle,
   * or throws an exception if this operation is not valid.
   */
  binary setCircle(1:binary set_circle_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for CircleFeed.
   * Set all field of Circle,
   * or throws an exception if this operation is not valid.
   */
  binary setCircleFeed(1:binary set_circle_feed_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for BookAuthor.
   * Set all field of BookAuthor,
   * or throws an exception if this operation is not valid.
   */
  binary setBookAuthor(1:binary set_book_author_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for MediaEvent.
   * Set all field of MediaEvent,
   * or throws an exception if this operation is not valid.
   */
  binary setEvent(1:binary set_event_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Competition.
   * Set all field of Competition,
   * or throws an exception if this operation is not valid.
   */
  binary setCompetition(1:binary set_competition_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for Match.
   * Set all field of Match,
   * or throws an exception if this operation is not valid.
   */
  binary setMatch(1:binary set_match_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for CircleFeedComment.
   * Set all field of CircleFeedComment,
   * or throws an exception if this operation is not valid.
   */
  binary setCircleFeedComment(1:binary set_circle_feed_comment_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for ComicBook.
   * Set all field of ComicBook,
   * or throws an exception if this operation is not valid.
   */
  binary setComicBook(1:binary set_comic_book_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for ComicBookChapter.
   * Set all field of ComicBookChapter,
   * or throws an exception if this operation is not valid.
   */
  binary setComicBookChapter(1:binary set_comic_book_chapter_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for ContentProvider.
   * Set all field of ContentProvider,
   * or throws an exception if this operation is not valid.
   */
  binary setContentProvider(1:binary set_content_provider_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for SubjectPage.
   * Set all field of SubjectPage,
   * or throws an exception if this operation is not valid.
   */
  binary setSubjectPage(1:binary set_subject_page_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for PaopaoActivity.
   * Set all field of PaopaoActivity,
   * or throws an exception if this operation is not valid.
   */
  binary setPaopaoActivity(1:binary set_paopao_activity_request)
      throws (1:InvalidWriteOperation e);

/**
   * The write interfaces of setting for PaopaoCollection.
   * Set all field of PaopaoCollection,
   * or throws an exception if this operation is not valid.
   */
  binary setPaopaoCollection(1:binary set_paopao_collection_request)
      throws (1:InvalidWriteOperation e);

/**
   * The write interfaces of setting for IntellectualProperty.
   * Set all field of IntellectualProperty,
   * or throws an exception if this operation is not valid.
   */
  binary setIntellectualProperty(1:binary set_intellectual_property_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for HeadLine.
   * Set all field of HeadLine,
   * or throws an exception if this operation is not valid.
   */
  binary setHeadLine(1:binary set_head_line_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for HotEvent.
   * Set all field of HotEvent,
   * or throws an exception if this operation is not valid.
   */
  binary setHotEvent(1:binary set_hot_event_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for OpenRichMedia.
   * Set all field of OpenRichMedia,
   * or throws an exception if this operation is not valid.
   */
  binary setOpenRichMedia(1:binary set_open_rich_media_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for PeopleImage.
   * Set all field of PeopleImage,
   * or throws an exception if this operation is not valid.
   */
  binary setPeopleImage(1:binary set_people_image_request)
      throws (1:InvalidWriteOperation e);
 ...
 /**
   ...
   * checkVersion
   */
  binary checkVersion(1:binary set_graph_entity_request)
      throws (1:InvalidWriteOperation e);
  ...
  /**
   * The write interfaces of setting for LiveAct.
   * Set all field of LiveAct,
   * or throws an exception if this operation is not valid.
   */
  binary setLiveAct(1:binary set_live_act_request)
      throws (1:InvalidWriteOperation e);

  /**
   * The write interfaces of setting for PizzaVideo.
   * Set all field of PizzaVideo,
   * or throws an exception if this operation is not valid.
   */
  binary setPizzaVideo(1:binary set_pizza_video_request)
      throws (1:InvalidWriteOperation e);
}
