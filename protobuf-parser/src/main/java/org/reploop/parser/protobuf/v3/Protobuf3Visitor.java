// Generated from org/reploop/parser/protobuf/v3/Protobuf3.g4 by ANTLR 4.8
...
public interface Protobuf3Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Protobuf3Parser#optionBody}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOptionBody(Protobuf3Parser.OptionBodyContext ctx);
	/**
	 * Visit a parse tree produced by {@link Protobuf3Parser#optionBodyVariable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOptionBodyVariable(Protobuf3Parser.OptionBodyVariableContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Protobuf3Parser#extend}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExtend(Protobuf3Parser.ExtendContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Protobuf3Parser#rangeRule}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRangeRule(Protobuf3Parser.RangeRuleContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Protobuf3Parser#typeRule}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypeRule(Protobuf3Parser.TypeRuleContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Protobuf3Parser#reservedWord}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReservedWord(Protobuf3Parser.ReservedWordContext ctx);
	/**
