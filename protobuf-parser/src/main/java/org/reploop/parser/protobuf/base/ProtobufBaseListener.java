...
public interface ProtobufBaseListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterIntValue(ProtobufBaseParser.IntValueContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void exitIntValue(ProtobufBaseParser.IntValueContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void enterFloatValue(ProtobufBaseParser.FloatValueContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void exitFloatValue(ProtobufBaseParser.FloatValueContext ctx);
