...
public class Field extends Node {
	...
	public Field(FieldModifier modifier, Integer index, String name, FieldType type, Optional<Value> value) {
	...
	public Field(FieldModifier modifier, Integer index, String name, FieldType type, Optional<Value> value,
			List<String> comments, List<Option> options) {
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		Field field = (Field) o;
		return Objects.equals(modifier, field.modifier) && Objects.equals(index, field.index)
	...
	public String toString() {
		return "Field{" + "modifier=" + modifier + ", index=" + index + ", name='" + name + '\'' + ", type=" + type
